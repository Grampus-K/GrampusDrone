...
class EGOPlannerManager {
    public:
        ...
        bool computeInitState(const Eigen::Vector3d &start_pt, const Eigen::Vector3d &start_vel,
        ...
        void getLocalTarget(const double planning_horizen, const Eigen::Vector3d &start_pt,
