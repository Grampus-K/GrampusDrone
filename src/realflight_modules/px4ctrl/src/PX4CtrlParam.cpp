...
void Parameter_t::config_from_ros_handle(const ros::NodeHandle &nh)
{
	...
	read_essential_param(nh, "gain/Ka0", gain.Ka0);
	read_essential_param(nh, "gain/Ka1", gain.Ka1);
	read_essential_param(nh, "gain/Ka2", gain.Ka2);
	read_essential_param(nh, "gain/Kyaw", gain.Kyaw);
